...
export const generateFakeUser = async (role) => {
    ...
    return {
      ...
      // replacing interestedProjects
      // TODO: see where on frontend needs to be updated
      appliedToProjects: [],
      declinedProjects: [],
      ownerOfProjects: [],
      memberOfProjects: [],
    ...
    engineering: [
      {
        ...
        description: 'problem solving, excellent user-experience, collaborating with all types of engineers and designers',
    ...
    design: [
      {
        ...
        decription: 'developing products with all users in mind, advocating for a diverse user set and collaborating with other designers',
